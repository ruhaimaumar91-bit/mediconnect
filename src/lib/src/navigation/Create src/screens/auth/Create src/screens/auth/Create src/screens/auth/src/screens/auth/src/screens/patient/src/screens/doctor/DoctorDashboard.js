    ...
    <ScrollView
      ...
      <View style={{
        ...
        <View style={{
          ...
          <View style={{
            backgroundColor: '#2A9D8F', borderRadius: 12,
      ...
      <View style={{ padding: 24 }}>
        ...
        <View style={{
          ...
          {[
            ...
            <View key={stat.label} style={{
              ...
              <Text style={{
                fontSize: 20, fontWeight: 'bold', color: '#264653'
              }}>
                {stat.value}
              </Text>
        ...
        <View style={{ flexDirection: 'row', gap: 12, marginBottom: 24 }}>
          {[
            ...
            { icon: '👥', label: 'My Patients', tab: 'patients' },
        ...
        {tabs.map((tab) => (
          <TouchableOpacity
            ...
            <View style={{
              ...
              height: 3, backgroundColor: '#264653',
            ...
            <Text style={{
              ...
              color: activeTab === tab.id ? '#264653' : '#6B7280'
            }}>
              {tab.label}
            </Text>
          </TouchableOpacity>
